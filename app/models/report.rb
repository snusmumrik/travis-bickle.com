class Report < ActiveRecord::Base
  ...
  attr_accessible :driver_id, :car_id, :account_receivable, :advance, :cash, :deficiency_account, :deleted_at, :edy, :fuel_cost, :fuel_cost_lpg, :meter_fare_count, :mileage, :passengers, :riding_count, :riding_mileage, :sales, :extra_sales, :surplus_funds, :ticket, :started_at, :finished_at
  acts_as_paranoid
