...
describe "tax_withholdings/edit" do
  before(:each) do
  ...
  it "renders the edit tax_withholding form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", tax_withholding_path(@tax_withholding), "post" do
