...
#         post :create, {:talk => { "sender_user_id" => "invalid value" }}, valid_session
#         assigns(:talk).should be_a_new(Talk)
#       end
...
#         Talk.any_instance.should_receive(:update_attributes).with({ "sender_user_id" => "1" })
#         put :update, {:id => talk.to_param, :talk => { "sender_user_id" => "1" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Talk.any_instance.stub(:save).and_return(false)
#         put :update, {:id => talk.to_param, :talk => { "sender_user_id" => "invalid value" }}, valid_session
#         assigns(:talk).should eq(talk)
#       end
